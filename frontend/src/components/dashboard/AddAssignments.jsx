...
export default function AddAssignmentModal({ onClose }) {
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <div className="relative bg-white w-full sm:max-w-md rounded-t-2xl sm:rounded-2xl shadow-xl p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 mt-8">
          ...
          <button onClick={handleSubmit} className="w-full sm:w-auto px-5 py-2.5 rounded-xl text-sm font-semibold bg-indigo-400 hover:bg-indigo-500 text-white transition-colors">Add Assignment</button>
        </div>
      </div>
    </div>
  );
